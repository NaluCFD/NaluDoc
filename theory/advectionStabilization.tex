...
the width of the transition (see Equation~\ref{tanhGen}).
The general tanh form is as follows,
\begin{equation}
...
the transition. The constants $a$ and $b$ represent the interval bounds of the functional tanh form. In the 
Nalu formulation, the interval ranges between zero and unity. This approach ensures that the function 
starts at zero and asymptotes to unity,
\begin{equation}
