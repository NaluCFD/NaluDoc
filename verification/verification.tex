...
solution was simply, $T(x,y,z) = x + y + z$ with the analytical temperature gradient of unity. Table~\ref{tab:linearPatch} 
demonstrates the results for a P1 CVFEM implementation.
...
\begin{table}[h!]
  ...
  \begin{tabular}{llll}
    dof & Infinity Norm & One Norm & Two Norm\\
    \hline
