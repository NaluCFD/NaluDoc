...
\begin{figure}
  ...
  {
    \centerline{\includegraphics[width=0.4\textwidth]{figures/dgNonconformalCVFEM_3dTempMMS_OoC.pdf}}
  }
  \subfigure [Projected nodal gradient norms for P1 and P2 elements.]
  {
    \centerline{\includegraphics[width=0.4\textwidth]{figures/dgNonconformalCVFEM_3dTempMMS_OoCPNG.pdf}}
  }
  \vspace{0.1in}
